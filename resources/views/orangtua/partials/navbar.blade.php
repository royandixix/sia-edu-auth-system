<header class="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-6 sticky top-0 z-20">
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="hidden sm:flex items-center gap-2 pl-1">
            <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-green-500 to-green-700 flex items-center justify-center text-white font-bold text-xs">
                {{ strtoupper(substr(session('username','OT'),0,2)) }}
            </div>
